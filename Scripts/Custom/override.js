...
function add_status_colour(status, id) {
  var triangle = $('.chart-triangle.hidden').clone();
...
function chart_hazards2_render() {
  // hazards found chart
  var chartHazards2 = new CanvasJS.Chart("hazardsFound2", {
      data: [
        {
          showInLegend: false,
          indexLabelFontSize: '14',
  ...
  chartHazards2.render();
  //append triangle with relevant status
    var status = "amber"
    var id = "#hazardsFound2";
    add_status_colour(status, id);
}

function chart_tasks2_render() {
  // tasks completed chart
  var chartTasksComplete2 = new CanvasJS.Chart("tasksComplete2", {
      data: [
        {
          showInLegend: false,
          indexLabelFontSize: '14',
  ...
  chartTasksComplete2.render();
  //append triangle with relevant status
    var status = "green"
    var id = "#tasksComplete2";
    add_status_colour(status, id);
}

function chart_hazards3_render() {
  // hazards found chart
  var chartHazards3 = new CanvasJS.Chart("hazardsFound3", {
      data: [
        {
          showInLegend: false,
          indexLabelFontSize: '14',
  ...
  chartHazards3.render();
  //append triangle with relevant status
    var status = "red"
    var id = "#hazardsFound3";
    add_status_colour(status, id);
}

function chart_inspections_completed_render() {
  //inspections not completed column chart
var chartInspectionsCompleted = new CanvasJS.Chart("inspectionsCompleted", {
      title:{
        text: "Inspections Not Completed",
        fontSize: "18"
      },
  ...
  chartInspectionsCompleted.render();
  //append triangle with relevant status
  var status = "red"
  var id = "#inspectionsCompleted";
  add_status_colour(status, id);
}
...
function export_table() {
  //export table to CSV - export data directly?
}